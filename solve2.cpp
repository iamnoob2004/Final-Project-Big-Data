...
signed main(){
    ...
    for(int i=0; i<n; ++i){
        ...
        gr[i]=-1;
        if(msk==7){
            if(a[i].second[1]>0.8) gr[i]=0;
            else if(a[i].second[1]>0.6) gr[i]=1;
            else gr[i]=2;
        }
        else if(msk==14){
            if(a[i].second[2]>0.8) gr[i]=3;
            else if(a[i].second[2]>0.6) gr[i]=4;
            else gr[i]=5;
        }
        else if(msk==15){
            if(a[i].second[1]>0.8) gr[i]=6;
            else if(a[i].second[2]>0.8) gr[i]=7;
            else gr[i]=8;
        }
        if(gr[i]!=-1){
            cnt2[gr[i]]++;
